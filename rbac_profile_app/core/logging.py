...
# ContextVar to track request-scoped IDs across threads/tasks
...
def get_logger(name: str = "rbac_logger") -> logging.Logger:
    """Returns a configured logger instance bound to stdout, JSON file, and plaintext log file."""
